...
\zetLang{3.5}{6_of_clubs}{jack_of_diamonds}{jack_of_hearts}{6_of_spades}{Een \kaart{6} op een \kaart{boer}}{(Ver)plaats het shotglaasje op \'e\'en van de \ul{open} stapels, proost op \\ \quotes{van der Plas} en \textbf{neem een dubbele Frits}.}{Niemand mag nu opleggen op de stapel met het shotglaasje en die er direct orthogonaal aan grenzen.}{\ul{\texttt{LET OP}}: Niet gebruiken met \'e\'en kaart in je hand! \\ \ul{\texttt{LET OP}}: Haal het shotglaasje in je volgende beurt weer weg!}
