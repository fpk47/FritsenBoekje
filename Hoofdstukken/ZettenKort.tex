...
\begin{minipage}[t]{.48\textwidth}
  \vspace{0.317cm}
  \zetKortMetKruis{Zet - Hoger opleggen}{6_of_spades}{7_of_spades}{10_of_hearts}{ace_of_hearts}{3_of_diamonds}{5_of_clubs}{Hoger op een kaart met \ul{hetzelfde} symbool.}
\end{minipage}% This must go next to `\end{minipage}`
\hspace{0.35cm} \vrule  \hspace{1.33cm}
\begin{minipage}[t]{.48\textwidth}
  \vspace{0.317cm}
  \zetKortMetKruis{Zet - De aas en de 2}{ace_of_clubs}{2_of_clubs}{ace_of_hearts}{2_of_hearts}{ace_of_spades}{6_of_spades}{Een \kaart{2} op een \kaart{aas} met \ul{hetzelfde} symbool.}
\end{minipage}
...
\vspace{-0.1cm}
\zetLangMetKruis{\localHeight}{4_of_clubs}{9_of_diamonds}{black_joker}{9_of_spades}{Een \kaart{9} op \ul{elke} kaart behalve een \kaart{joker}}{}{}{\ul{\texttt{LET OP}}: Als de \kaart{9} op een \kaart{9} wordt gelegd, moeten de andere spelers proosten op \quotes{iedereen dubbelfrits} en \textbf{een dubbele Frits nemen}.}
