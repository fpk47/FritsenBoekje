...
\footnotetext[3]{gebruik bij twijfel regel \ref{item:beslissingCriteria} op pagina \pageref{item:beslissingCriteria} }
\footnotetext[4]{zie regels \ref{zet:Jesse}, \ref{zet:Jesse_2} en \ref{zet:Erik_Thierry} op pagina \pageref{zet:Erik_Thierry}}