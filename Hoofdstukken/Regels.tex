...
\footnotetext[1]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
...
\footnotetext[1]{\textbf{een dubbele Frits nemen} is equivalent aan twee keer \Fritsen (zie definities \ref{item:enkel_fritsen_equivalent} en \ref{item:dubbelfritsen_equivalent} op pagina \pageref{item:dubbelfritsen_equivalent})}
\footnotetext[2]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
...
\footnotetext[2]{\textbf{een Victortje nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
...
\customBoxItalic{Fritsen begint nadat \Frits en \Willem zijn bepaald. Hierna schudt iemand de kaarten en geeft \Frits iedereen vijf dichte startkaarten om vervolgens de eerste stapel open te leggen. De regels in deze sectie beschrijven het spelverloop op pagina \pageref{sec:introductie}.}
...
\footnotetext[2]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[3]{\textbf{een dubbele Frits nemen} is equivalent aan twee keer \Fritsen (zie definities \ref{item:enkel_fritsen_equivalent} en \ref{item:dubbelfritsen_equivalent} op pagina \pageref{item:dubbelfritsen_equivalent})}
...
\footnotetext[3]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
...
\customBoxItalic{Vuil Fritsen is het drinken en daarna inwisselen van je vijf startkaarten voordat \Willem als eerste aan de beurt\footnotemark[1] is. Een slechte hand bestaat uit meerdere kaarten met de waarde lager dan een \ul{\textbf{9}}. Je mag zo vaak vuil Fritsen als je wil.}
...
\footnotetext[1]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[2]{\textbf{een dubbele Frits nemen} is equivalent aan twee keer \Fritsen (zie definities \ref{item:enkel_fritsen_equivalent} en \ref{item:dubbelfritsen_equivalent} op pagina \pageref{item:dubbelfritsen_equivalent})}
\footnotetext[3]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
...
\item Een zet\footnotemark[5] doen of een nieuwe \ul{open} \textbf{stapel} beginnen.
\eindPuntLijst{}
...
\vervolgLijst{}
\item \EenSpeler is niet verplicht om een zet\footnotemark[5] te doen voordat en nadat diegene twee nieuwe \textbf{kaarten} heeft gepakt.
\eindLijst{}

\vervolgLijst{}
\item In de beurt\footnotemark[1] van \eenSpeler moet diegene \'e\'en zet\footnotemark[5] doen of \'e\'en nieuwe \ul{open} \textbf{stapel} beginnen als diegene nog \textbf{kaarten} heeft.
\eindLijst{}

\footnotetext[1]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[2]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[3]{zie definite \ref{def:fritsen} op pagina \pageref{def:fritsen}}
\footnotetext[4]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[5]{zie pagina \pageref{sec:regels_kort}, \pageref{zetkort:caroline}, \pageref{sec:zettenLang} en \pageref{sec:zettenLang_2}}
...
\footnotetext[3]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[4]{zie de desbetreffende zetten op pagina \pageref{zet:kim} en \pageref{zet:joris} en regel \ref{regel:Erik_Thierry} op pagina \pageref{regel:Erik_Thierry} en regel regel \ref{regel:Erik_Caroline} op pagina \pageref{regel:Erik_Caroline}.}
...
\footnotetext[1]{\textbf{uitfritsen} is het neerleggen van je laatste \textbf{kaart(en)} (zie definitie \ref{item:uitfritsen} op pagina \pageref{item:uitfritsen})}
\footnotetext[2]{\textbf{een Fritsje des nemen} en \textbf{een uittreefritsje nemen} zijn equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[3]{\textbf{een dubbele Frits nemen} is equivalent aan twee keer \Fritsen (zie definities \ref{item:enkel_fritsen_equivalent} en \ref{item:dubbelfritsen_equivalent} op pagina \pageref{item:dubbelfritsen_equivalent})}
\footnotetext[4]{zie het stroomdiagram op de achterkant van dit document}
...
\footnotetext[4]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[5]{de \textbf{kaart} \kaart{Jesse Klaver} is equivalent aan een \kaart{klaveren 3} (zie pagina \pageref{sec:kaartnamen})}
\footnotetext[6]{de \textbf{kaart} \kaart{Thierry} is equivalent aan elke \kaart{6} (zie pagina \pageref{sec:kaartnamen})}
\footnotetext[7]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[8]{\textbf{een Erikje nemen} en \textbf{een Caroline'tje nemen} zijn equivalent aan \textbf{Dubbelfritsen} (zie definitie \ref{item:dubbelfritsen_equivalent} op pagina \pageref{item:dubbelfritsen_equivalent})}
...
\customBox{\textit{Vergeet niet om het shotglaasje bij je volgende beurt\footnotemark[2] van het speelbord te halen.}}

\vervolgLijst{}
\item \label{regel:caroline_weghalen} Als in de vorige beurt\footnotemark[2] van de \huidigeSpeler zet \ref{zet:caroline}\footnotemark[1] uitgevoerd is en diegene een shotglaasje op \'e\'en van de \ul{dichte} \textbf{stapels} heeft gezet, moet in de huidige beurt\footnotemark[2] het desbetreffende shotglaasje als eerste van de desbetreffende \textbf{stapel} gehaald worden.
\eindLijst{}
...
\customBox{\textit{Plaats alleen een shotglaasje in je eigen beurt\footnotemark[2] om stapels te blokkeren.}}
...
\footnotetext[1]{zie pagina \pageref{zetkort:caroline} en \pageref{zet:caroline}}
\footnotetext[2]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[3]{\textbf{een Fritsje des nemen} is equivalent aan \Fritsen (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
