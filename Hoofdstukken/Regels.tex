...
\vervolgLijst{}
    \item \EenSpeler mag alleen proosten op \quotes{offer Frits}, \quotes{kut Lisa}, \quotes{supermooi Lisa}, \quotes{kut Kim}, \quotes{supermooi Kim}, \quotes{Baudet} en \quotes{Chantal} als hij/zij de bijbehorende zet aan het uitvoeren is\footnotemark[2]. 
\eindLijst{}

\customBoxItalic{Leg alléén een kaart op wanneer dit mag.}

\vervolgLijst{}
    \item \EenSpeler mag alléén kaart(en) opleggen die in lijn zijn met de regels en zetten.
...
\footnotetext[1]{\textbf{een Fritsje des nemen} is equivalent aan \textbf{Fritsen} (zie definitie \ref{item:enkel_fritsen_equivalent})}
\footnotetext[2]{zie zetten \ref{zet:offer_frits}, \ref{zet:lisa} en \ref{zet:kim} op pagina \pageref{zet:kim} en zetten \ref{zet:joris} en  \ref{zet:thierry} op pagina \pageref{zet:joris}}
