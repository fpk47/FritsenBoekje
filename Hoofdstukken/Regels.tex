...
\puntLijst{}
\item Proosten op \quotes{dubbel Frits} en een \textbf{een dubbele Frits nemen}\footnotemark[1].
...
\item Geen handeling uitvoeren als diegene, tijdens het niet naleven van regel \ref{regel:kaart_pakken_buiten_beurt}, twee of meer \ul{dichte} \textbf{kaarten} van de \ul{dichte} \textbf{stapel} gepakt heeft. 
\eindNumeriekeLijst{}
\eindPuntLijst{}
