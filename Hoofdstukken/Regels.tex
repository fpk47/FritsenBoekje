...
\begin{tabular}{ll}
    \large{$\rightarrow$ Algemeen} & \hspace{0.5cm} \large{pagina 4 t/m 5} \\
    \large{$\rightarrow$ Beginfase} van het Spel & \hspace{0.5cm} \large{pagina 6}\\
    \large{$\rightarrow$ Vuil Fritsen} & \hspace{0.5cm} \large{pagina 7}\\
    \large{$\rightarrow$ Beurten en Zetten} & \hspace{0.5cm} \large{pagina 8 t/m 9} \\
    \large{$\rightarrow$ Jokers} & \hspace{0.5cm} \large{pagina 10}\\
    \large{$\rightarrow$ Thierry Baudet en Jesse Klaver} & \hspace{0.5cm} \large{pagina 11}
\end{tabular}
...
\vervolgLijst{}
    ...
    \puntLijst{}
        ...
        \item Twee \ul{dichte} kaarten pakken van bovenop de \ul{dichte} stapel.
    \eindPuntLijst{}
...
\customBoxItalic{\AlleSpelers hebben genoeg tijd om te beslissen of ze willen \textbf{vuil Fritsen}.}
...
\vervolgLijst{}
    ...
    \puntLijst{}
        ...
        \numeriekeLijst{}
            \item Een zet\footnotemark[1] doen.
...
\vervolgLijst{}
    \item Als \eenSpeler méér kaart(en) dan nodig pakt van de \ul{dichte} stapel, moet hij/zij deze in zijn/haar hand houden.
\eindLijst{}
...
\footnotetext[1]{zie het stroomdiagram op de achterkant van dit document}
\footnotetext[2]{\textbf{een Fritsje des nemen} is equivalent aan \textbf{Fritsen} (zie definitie \ref{item:enkel_fritsen_equivalent})}
\footnotetext[3]{zie pagina \pageref{sec:regels_kort} of hoofdstuk 6}
\footnotetext[4]{zie \texttt{stap} \texttt{3} op pagina \pageref{sec:introductie}}
...
\vervolgLijst{}
    \item \EenSpeler mag alleen proosten op \quotes{offer Frits}, \quotes{kut Lisa}, \quotes{supermooi Lisa}, \quotes{kut Kim}, \quotes{supermooi Kim} en \quotes{Chantal} als hij/zij de bijbehorende zet aan het uitvoeren is\footnotemark[1]. 
\eindLijst{}
...
\vervolgLijst{}
    \item \EenSpeler mag, tenzij elders beschreven, niet voor zijn/haar beurt\footnotemark[2] opleggen.
...
\vervolgLijst{}
    \item Als \eenSpeler regel \ref{regel:ongeldige_zet} of \ref{regel:voor_beurt_opleggen} niet naleeft, moet hij/zij:
    \puntLijst{}
...
\vervolgLijst{}
    \item Als regel \ref{regel:laatste_frits_2} niet wordt nageleefd, moet de \textbf{[huidige speler]}:
    \puntLijst{}
        \item Proosten op \quotes{Frits} en \textbf{een Fritsje des nemen}\footnotemark[3].
        \item Proosten op \quotes{Frits} en \textbf{een uittreefritsje nemen}\footnotemark[3].
    \eindPuntLijst{}
...
\vervolgLijst{}
    \item Als \eenSpeler als laatste van \alleSpelers nog niet \textbf{uitgefritst}\footnotemark[4] is, moet hij/zij:
    \puntLijst{}
        \item Proosten op \quotes{dubbel Frits} en \textbf{een dubbele Frits nemen}[REFERENTIE].
    \eindPuntLijst{}
\eindLijst{}

\vervolgLijst{}
    \item Een beurt\footnotemark[2] is voorbij nadat de \huidigeSpeler al zijn/haar beurtgerelateerde taken heeft verricht.
\eindLijst{}

\vervolgLijst{}
    \item De beurt\footnotemark[2] van \eenSpeler is meteen ten einde wanneer hij/zij \textbf{uitgefritst}\footnotemark[4] is aan het begin van zijn/haar beurt. 
\eindLijst{}

\vervolgLijst{}
    \item Als er nog maar \textbf{[\'e\'en speler]} niet \textbf{uitgefritst}\footnotemark[4] is en niemand van \alleSpelers meer hoeft te drinken, is het spel afgelopen.
\eindLijst{}
...
\vervolgLijst{}
    \item \EenSpeler moet van \alleSpelers weten wie aan de beurt\footnotemark[2] is en wie \textbf{uitgefritst}\footnotemark[4] zijn.
\eindLijst{}

\vervolgLijst{}
    \item Als niemand van \alleSpelers weet of wil vertellen wie aan de beurt\footnotemark[2] is, is \Frits aan de beurt\footnotemark[2].
\eindLijst{}

\vervolgLijst{}
    \item \EenSpeler kan zijn/haar \medeSpelers dwingen om naar waarheid te vertellen wie aan de beurt\footnotemark[2] is door:
    \puntLijst{}
        \item Dit aan te geven en \textbf{een Fritsje te nemen}\footnotemark[3].
    \eindPuntLijst{}
\eindLijst{}

\footnotetext[1]{zie zetten \ref{zet:offer_frits}, \ref{zet:lisa} en \ref{zet:kim} op pagina \pageref{zet:kim} en zet \ref{zet:joris} op pagina \pageref{zet:joris}}
...
\customBoxItalic{Tijdens je beurt\footnotemark[1] kun je de \andereSpelers laten drinken door een \kaart{joker}\footnotemark[2] op te leggen. De \kaart{joker}\footnotemark[2] heeft zijn eigen \textbf{stapel} en uitgaan met een \kaart{joker}\footnotemark[2] is niet toegestaan.}

\vervolgLijst{}
    \item Er moeten minimaal 2 en maximaal 3 \kaart{jokers}\footnotemark[2] per kaartspel gebruikt worden.
\eindLijst{}

\vervolgLijst{}
    \item Voordat \Willem zijn/haar eerste kaart heeft opgelegd\footnotemark[3] hebben \kaart{jokers}\footnotemark[2] geen drinkwaarde.
\eindLijst{}
...
\vervolgLijst{}
    \item \EenSpeler mag niet een nieuwe jokerstapel beginnen als er al \'e\'en ligt.
    \label{regel:joker_2}
\eindLijst{}

\vervolgLijst{}
    \item \EenSpeler mag, tenzij anders aangegeven, niet een kaart ongelijk aan een \kaart{joker}\footnotemark[2] op de jokerstapel leggen.
    \label{regel:joker_3}
\eindLijst{}
...
\vervolgLijst{}
    \item \EenSpeler mag niet een kaart opleggen waardoor de jokerstapel zich niet direct naast de \ul{dichte} \textbf{stapel} kan bevinden.
    \label{regel:joker_4}
\eindLijst{}
...
\vervolgLijst{}
    \item Als \Frits regel \ref{regel:delen_Frits_5_kaarten_1}, \ref{regel:delen_Frits_5_kaarten_2} of \ref{regel:eerst_kaart_open} aan het toepassen is, hebben de opgelegde \kaart{joker(s)}\footnotemark[2] geen drinkwaarde worden ze niet gezien als een jokerstapel.
\eindLijst{}   
