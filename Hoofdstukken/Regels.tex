...
\vervolgLijst{}
    \item Het spel wordt hervat wanneer \alleSpelers terug zijn na het uitvoeren van de acties beschreven in regels \ref{regel:stilleggen_1} en \ref{regel:stilleggen_2}. 
...
\vervolgLijst{}
    \item \EenSpeler mag alleen proosten op \quotes{offer Frits}, \quotes{kut Lisa}, \quotes{supermooi Lisa}, \quotes{kut Kim}, \quotes{supermooi Kim}, \quotes{Baudet}, \quotes{Chantal} en \quotes{supermooi Erik} als hij/zij de bijbehorende zet of regel aan het uitvoeren is\footnotemark[2]. 
\eindLijst{}
...
\footnotetext[1]{\textbf{een Fritsje des nemen} is equivalent aan \textbf{Fritsen} (zie definitie \ref{item:enkel_fritsen_equivalent})}
\footnotetext[2]{zie zetten \ref{zet:offer_frits}, \ref{zet:lisa} en \ref{zet:kim} op pagina \pageref{zet:kim}, zetten \ref{zet:joris} en  \ref{zet:thierry} op pagina \pageref{zet:joris} en regel \ref{regel:Erik}}
