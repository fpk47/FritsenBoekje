...
\vervolgLijst{}
\item \EenSpeler mag alleen proosten op \quotes{Baudet}, \quotes{Chantal}, \quotes{dubbelfrits}, \quotes{iedereen dubbelfrits}, \quotes{kut Kim}, \quotes{kut Lisa}, \quotes{offer Frits}, \quotes{supermooi Erik}, \quotes{supermooi Victor}, \quotes{van der Plas} en \quotes{vuile Frits} als diegene de bijbehorende zet aan het uitvoeren of regel aan het toepassen is\footnotemark[3]\footnotemark[4].
\eindLijst{}
...
\footnotetext[3]{zie de desbetreffende zetten op pagina \pageref{hoofdstuk:zettenLang} en \pageref{hoofdstuk:zettenLang_2} en regel 2-18 op pagina 7 en regel 2-100 op pagina 15.}
\footnotetext[4]{zie regel \ref{regel:Erik_Thierry} op pagina \pageref{regel:Erik_Thierry} en regel \ref{regel:Erik_Caroline} op pagina \pageref{regel:Erik_Caroline}.}
...
\footnotetext[5]{zie regel \ref{regel:waarheid_hoeveel_kaarten} op pagina \pageref{regel:waarheid_hoeveel_kaarten}}
...
\vervolgLijst{}
\item \label{regel:Erik_Caroline_2} \EenSpeler moet, tenzij diegene regel \ref{regel:Erik_Caroline} aan het toepassen is, te allen tijde proosten op \quotes{van der Plas} en \textbf{een Caroline’tje nemen}\footnotemark[8] bij het toepassen van zet \ref{zet:caroline}\footnotemark[1].
\eindLijst{}
...
\vervolgLijst{}
\item \EenSpeler mag na het starten van zet \ref{zet:caroline}\footnotemark[1] pas na 9 seconden het shotglaasje (ver)plaatsen en moet binnen 99 seconden het shotglaasje (ver)plaatsen.
...
\vervolgLijst{}
\item \label{regel:shotglaasje_aanraken_1} Als er zich een shotglaasje op \'e\'en van de \textbf{stapels} bevindt, mag deze eenmalig worden verplaatst door de \huidigeSpeler tijdens het uitvoeren van zet \ref{zet:caroline}\footnotemark[1].
\eindLijst{}

\vervolgLijst{}
\item \label{regel:shotglaasje_aanraken_2} Als er zich een shotglaasje op \'e\'en van de \textbf{stapels} bevindt, mag deze eenmalig worden verplaatst door de \huidigeSpeler als in de vorige beurt van diegene zet \ref{zet:caroline}\footnotemark[1] uitgevoerd is en daarna niemand van \alleSpelers zet \ref{zet:caroline}\footnotemark[1] heeft uitgevoerd.
\eindLijst{}
