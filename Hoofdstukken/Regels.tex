...
\vervolgLijst{}
    ...
    \puntLijst{}
        \item Proosten op \quotes{vierdubbel Frits} en \ul{twee keer} \textbf{een dubbele Frits nemen}\footnotemark[1]. 
...
\vervolgLijst{}
    \item \EenSpeler is verplicht naar waarheid te vertellen hoeveel persoonlijk resterende \textbf{kaarten} diegene heeft wanneer dit gevraagd wordt door een \medeSpelerN.
\eindLijst{}   
...
\vervolgLijst{}
    \item \Frits is niet verplicht om tijdens het delen\footnotemark[1] de \textbf{kaarten} netjes, recht of gepast te positioneren.
\eindLijst{}
...
\vervolgLijst{}
    \item Als \eenSpeler een nieuwe \ul{open} \textbf{stapel} begint, moet diegene deze orthogonaal\footnotemark[1] en aansluitend positioneren ten opzichte van de bestaand \textbf{stapels}.
...
\vervolgLijst{}
    \item \EenSpeler mag alleen proosten op \quotes{offer Frits}, \quotes{kut Kim}, \quotes{Chantal}, \quotes{kut Lisa}, \quotes{Baudet}, \quotes{van der Plas}, \quotes{supermooi Erik} en \quotes{supermooi Victor} als diegene de bijbehorende zet aan het uitvoeren of regel aan het toepassen is\footnotemark[3]. 
\eindLijst{}

\footnotetext[1]{zie de speelborden op pagina \pageref{zetkort:caroline}}
\footnotetext[2]{\textbf{een Fritsje des nemen} is equivalent aan \textbf{Fritsen} (zie definitie \ref{item:enkel_fritsen_equivalent} op pagina \pageref{item:enkel_fritsen_equivalent})}
\footnotetext[3]{zie zetten \ref{zet:offer_frits}, \ref{zet:lisa} en \ref{zet:kim} op pagina \pageref{zet:kim}, zetten \ref{zet:joris} \ref{zet:thierry} en \ref{zet:caroline} op pagina \pageref{zet:joris} en regel \ref{regel:Erik_Thierry} op pagina \pageref{regel:Erik_Thierry}.}
...
\newpage
\drawBar{Regels - Vervolg}
\deelhoofdstuk{\proLabel Regels - Caroline van der Plas}
\label{sec:caroline}
...
\customBox{\textit{Het shotglaasje blokkeert stapels waardoor andere spelers moeilijker kunnen opleggen.}}
...
\newpage
\drawBar{Regels - Vervolg}
\deelhoofdstuk{\proLabel Regels - Caroline van der Plas - Vervolg}
...
\customBox{\textit{Raak en verplaats niet het shotglaasjes van een \andereSpelerN.}}
