...
\footnotetext[3]{\footnoteFritsjeDesNemen}
\footnotetext[4]{zie de desbetreffende zetten op pagina \pageref{hoofdstuk:zettenLang} en \pageref{hoofdstuk:zettenLang_2} en regel \ref{regel:Erik_Thierry} op pagina \pageref{regel:Erik_Thierry} en regel \ref{regel:Erik_Caroline} op pagina \pageref{regel:Erik_Caroline}.}
