...
\footnotetext[1]{zie definitie \ref{item:lisa} op pagina \pageref{item:lisa}} 
...
\footnotetext[3]{zie definitie \ref{item:kim} op pagina \pageref{item:kim}} 
...
\vervolgLijst{}
    ...
    \puntLijst{}
        ...
        \item Één van de volgende acties uitvoeren:
        \numeriekeLijst{}
            \item Een shotglaasje op \'e\'en van de \ul{open} stapels plaatsen als er zich nog geen shotglaasje op \'e\'en van de \ul{open} stapels bevindt.
            \item Het \ul{huidige} shotglaasje dat zich op \'e\'en van de \ul{open} bevindt verplaatsen naar een andere \ul{open} stapel.
            \item Het \ul{huidige} shotglaasje dat zich op \'e\'en van de \ul{open} bevindt \ul{niet} verplaatsen.
        \eindNumeriekeLijst{}
    \eindPuntLijst{}
    \label{zet:caroline}
\eindLijst{} 
