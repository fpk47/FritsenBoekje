...
\customBox{\textit{\textbf{Uitfritsen} (het neerleggen van je laatste kaart) is met zetten} \ref{zet:thierry}\textit{,} \ref{zet:joker_1} \textit{en} \ref{zet:joker_2} \textit{niet toegestaan.}}
