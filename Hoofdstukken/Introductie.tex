...
\hfill
\begin{minipage}[t]{.91\textwidth}
\Frits begint een nieuwe open stapel met de bovenste kaart van de \ul{dichte} stapel. Als die kaart een \textbf{\ul{joker}} is, legt \Frits nogmaals een kaart van de \ul{dichte} stapel open op dezelfde stapel net zo lang totdat de opengelegde kaart geen \kaart{joker} is.
\end{minipage}
...
\hfill
\begin{minipage}[t]{.91\textwidth}
Als je tijdens het spelen \ul{als laatste} nog kaarten hebt, moet je proosten op \quotes{dubbelfrits} en \textbf{een dubbele Frits nemen}. Daarna is het spel afgelopen.  \\
\end{minipage}
