...
\begin{minipage}[c][2.5cm][c]{1.0\textwidth}
    \begin{tabularx}{\textwidth}{Xccccm{0.30cm}}
        ...
        \ifx&#2&%
            &
        \else
            \includegraphics[height=2cm]{img/cards/#2.png} \hspace{0.06cm} &
        \fi
        \ifx&#3&%
            &
        \else
            \includegraphics[height=2.0cm]{img/cards/#3.png} \hspace{0.06cm} &
        \fi
        \ifx&#4&%
            &
        \else
            \includegraphics[height=2.0cm]{img/cards/#4.png} \hspace{0.06cm} &
        \fi
        \ifx&#5&%
            &
        \else
            \includegraphics[height=2.0cm]{img/cards/#5.png} &
        \fi
    \end{tabularx}
\end{minipage}
}
