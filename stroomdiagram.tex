...
% Define block styles
\tikzstyle{thickBlock} = [rectangle, draw, fill=green!15, 
...
\tikzstyle{cloud} = [draw, rectangle, thick, rounded corners=8, fill=red!20, minimum height=2em, text width=12em, text badly centered]
