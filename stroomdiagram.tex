...
\begin{figure}[H]
   \centering
    ...
    \node [cloud, right=of block_1] (cloud_1) {Heb je \'e\'en of meer kaarten?};
    ...
    \node [cloud, right=of block_2] (cloud_3) {Heb je \'e\'en kaart?};
    \node [cloud, below=of cloud_3] (cloud_4) {Heb je geen kaarten?};
    ...
    \node [cloud, below=of block_5] (cloud_5) {Kan \'en wil je een zet\footnotemark[1] doen?};
...
\footnotetext[1]{zie pagina \pageref{hoofdstuk:regels_kort}, \pageref{zetkort:caroline}, \pageref{hoofdstuk:zettenLang} en \pageref{hoofdstuk:zettenLang_2}}
\footnotetext[2]{\Fritsen is het drinken van één shotglaasje bier (zie definitie \ref{definitie:fritsen} op pagina \pageref{definitie:fritsen})}
\footnotetext[3]{zolang er dichte kaarten zijn (zie regels \ref{item:geen_kaart_1} en \ref{item:geen_kaart_2} op pagina \pageref{item:geen_kaart_1})}
\newpage
